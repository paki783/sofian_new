                                            ...
                                            <tbody>
                                                @foreach($data as $d)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if(!empty($d->getCourse->getPictures))
                                                                <?php $count = 1; ?>
                                                                <div class="btn-group">
                                                                    @foreach($d->getCourse->getPictures as $p)
                                                                        <a href="{{ asset('storage/app/public') }}/{{ $p->path }}" download class="btn-btn-default">Attachment <?= $count; ?></a>
                                                                        <?php $count++; ?>
                                                                    @endforeach
                                                                </div>
                                                            @endif
